...
- 마무리 = (필요할 때만) 행동 유도 한 줄. 모든 글이 CTA로 끝날 필요 없음 — 그냥 혼잣말로 끝나도 됨.
...
- 특히 한 버전은 '진짜 짧게' 써라 — 한두 줄, 심하면 한 문장. 세 개가 다 비슷한 분량이면 실패다.
- 세 버전이 똑같이 '훅 → 설명 → CTA' 틀을 따르면 안 된다. 어떤 건 그냥 혼잣말로 툭 끝나도 된다.
